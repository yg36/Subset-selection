...
Subset selection and combo-finder notebook for combinatorial search practice.
...
- `README.md`
- `Subset_Selection_Problem.ipynb`
...
<!-- repository-refresh: 2026-06-29 | preserved-order-rank: 017/71 -->

<!-- github-activity-refresh:start -->
repo: Subset-selection
